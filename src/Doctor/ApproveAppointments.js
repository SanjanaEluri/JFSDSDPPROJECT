...
const ApproveAppointments = () => {
  ...
  const handleAccept = (id) => {
    axios
      .post(`https://jfsdsdpbackend.up.railway.app/updateappointmentstatus?id=${id}&status=Accepted`)
      .then(() => {
  ...
  const handleReject = (id) => {
    axios
      .post(`https://jfsdsdpbackend.up.railway.app/updateappointmentstatus?id=${id}&status=Rejected`)
      .then(() => {
