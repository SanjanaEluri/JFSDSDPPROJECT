...
export default function SignUp() {
  ...
  const fetchAvailableSlots = async (date) => {
    ...
    try {
      const response = await axios.get(
        `https://jfsdsdpbackend.up.railway.app/viewappointmenttimings?did=${formData.doctorid}&date=${date}`
      );
  ...
  const fetchDoctors = async () => {
    ...
    try {
      const response = await axios.get(
        `https://jfsdsdpbackend.up.railway.app/viewdocbyspecalisation?spec=${formData.specalist}`
      );
      if (response.data) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://jfsdsdpbackend.up.railway.app/patientappointment",
        formData,
        {
          headers: {
