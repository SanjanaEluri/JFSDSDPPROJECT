    ...
    if (storedDoctorData) {
      ...
      const fetchDoctorProfile = async () => {
        try {
          ...
          const profileResponse = await axios.get(`https://jfsdsdpbackend.up.railway.app/doctorprofile/${id}`);
          ...
          if (doctorProfileData && doctorProfileData.id) {
            const imageResponse = await axios.get(`https://jfsdsdpbackend.up.railway.app/doctorprofile/image/${doctorProfileData.id}`, {
